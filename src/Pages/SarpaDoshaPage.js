    ...
    <div className="sarpa-dosha-page">
      <div className="sarpa-dosha-content">
        ...
        <p className="sarpa-dosha-intro">
          Sarpa Dosha Parihara is a ritual remedy performed to appease serpent
          deities and remove the ill effects of Sarpa Dosha. It helps overcome
          obstacles in marriage, health, and progeny, bringing peace and balance
          in life.
        </p>
